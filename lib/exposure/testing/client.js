...
describe('Exposure Tests', function () {
  ...
  // TODO(v3): https://github.com/Meteor-Community-Packages/meteor-publish-composite/issues/175
  // this.observeHandle.stop is not a function error
  it.skip('Should intersect the body graphs - Subscription', function (done) {
    const query = Intersect.createQuery({
      $filters: {
        value: 'Hello',
      },
