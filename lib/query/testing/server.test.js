...
// for links on nested fields
const Files = new Mongo.Collection('test_files');
const Projects = new Mongo.Collection('test_projects');
...
describe('Hypernova', function() {
    ...
    it('Should work with links on nested fields - one', () => {
        ...
        const projectId = Projects.insert({name: 'Project 1'});
        Files.insert({
            filename: 'test.txt',
            meta: {
                type: 'text',
    ...
    it('Should work with links on nested fields - many', () => {
        ...
        const p1 = Projects.insert({name: 'Project 1'});
        const p2 = Projects.insert({name: 'Project 2'});
        Files.insert({
            filename: 'test.txt',
            metas: [{
                type: 'text',
